          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-80 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/20 dark:bg-dark-900/20 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/25 focus:border-brand-500 dark:focus:border-brand-400 transition-all font-sans resize-none leading-relaxed"
                maxLength={maxLimit}
              />
            ...
            {result ? (
              ...
              >
                <GlassCard className={`border-2 ${result.prediction === 'Fake Job' ? 'border-red-500/20 dark:border-red-400/20 bg-red-50/5 dark:bg-red-950/5' : 'border-emerald-500/20 dark:border-emerald-400/20 bg-emerald-50/5 dark:bg-emerald-950/5'}`}>
                  ...
                  <div className="flex gap-2.5 mt-5 border-t border-slate-200/50 dark:border-slate-800/50 pt-4">
                    <button
                      onClick={handleCopy}
